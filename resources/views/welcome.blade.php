                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('request_surat') }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            @enderror">
                                                ...
                                                <option value="3">Surat Penelitian</option>
                                                <option value="4">Surat Kerja Praktek</option>
                                            </select>
                                            @error('jenis')
                                        ...
                                        <div class="form-group">
                                            <textarea name="tempat_kp" id="tempat_kp" class="form-control @error('tempat_kp')
                                                is-invalid
                                            @enderror" cols="20" rows="5" placeholder="Tempat KP" value="{{ old('tempat_kp') }}"></textarea>
                                            @error('tempat_kp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
