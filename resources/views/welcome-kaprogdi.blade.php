                                               ...
                                               @foreach ($datas as $item)
                                                   <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/download-kaprogdi/{{ $item->berkas }}"><button class="btn btn-success">Download</button></a>
                                                        </td>
                                                   </tr>
                                               @endforeach
                                           </tbody>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('upload-kaprogdi') }}" method="post" enctype="multipart/form-data">
                        @csrf
